<template>
    ...
    >
        <Rack :section="section" side="left" :scale="scale" />
        <Shelves
        ...
        <Rack :section="section" side="right" :scale="scale" />
    </div>
</template>
...
import { findShelfById } from '@planogram/composables/plannerate/v3/editor/useLookupHelpers';
...
import {
    calculateHoles,
    findNearestHole,
} from '@planogram/composables/plannerate/v3/useSectionHoles';
import type { Section as SectionType } from '@planogram/types/planogram';
...
const sectionStyle = computed(() => ({
    ...
    marginLeft: props.firstSection ? '0' : `-${rackWidth.value}px`,
}));
