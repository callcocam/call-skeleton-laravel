        ...
        <TooltipProvider :delay-duration="200">
            <Tooltip>
                <TooltipTrigger as-child>
                    <div
                        class="absolute top-1/2 left-1/2 z-[100] -translate-x-1/2 -translate-y-1/2 cursor-pointer rounded-full bg-white/95 p-1.5 shadow-sm backdrop-blur-sm transition-transform hover:scale-105"
                        :class="{
