...
import AiSettingsSection from '@planogram/components/plannerate/v3/header/partials/AiSettingsSection.vue';
import AdvancedOptionsSection from '@planogram/components/plannerate/v3/header/partials/AdvancedOptionsSection.vue';
import CategorySelect from '@planogram/components/plannerate/v3/sidebar/products/CategorySelect.vue';
import FacingsSettingsSection from '@planogram/components/plannerate/v3/header/partials/FacingsSettingsSection.vue';
import GenerationModeSettings from '@planogram/components/plannerate/v3/header/partials/GenerationModeSettings.vue';
import SalesDataSection from '@planogram/components/plannerate/v3/header/partials/SalesDataSection.vue';
import StrategySelectionSection from '@planogram/components/plannerate/v3/header/partials/StrategySelectionSection.vue';
