<script lang="ts">
import { validateShelfFields } from '@planogram/composables/plannerate/v3/useShelfFields';
...
import { calculateUsableHeight } from '@planogram/composables/plannerate/v3/useSectionFields';
import {
