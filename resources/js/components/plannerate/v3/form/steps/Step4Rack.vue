...
<template>
    <div class="space-y-4">
        <div class="flex items-center gap-2">
            ...
            <h3 class="text-lg font-medium">Configurar Rack</h3>
        </div>

        <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
            <div class="space-y-2">
                <Label for="rackWidth">Largura da Rack (cm) *</Label>
                <Input
                    id="rackWidth"
                    type="number"
                    v-model.number="formData.rackWidth"
                    min="1"
                    :class="{
        ...
        <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
            <div class="space-y-2">
                ...
                <Input
                    id="holeHeight"
                    type="number"
                    v-model.number="formData.holeHeight"
                    min="1"
                    :class="{
            ...
            <div class="space-y-2">
                ...
                <Input
                    id="holeWidth"
                    type="number"
                    v-model.number="formData.holeWidth"
                    min="1"
                    :class="{
            ...
            <div class="space-y-2">
                ...
                <Input
                    id="holeSpacing"
                    type="number"
                    v-model.number="formData.holeSpacing"
                    min="1"
                    :class="{
