...
} from '@planogram/composables/plannerate/v3/useGondolaFields';
import { DEFAULT_SECTION_FIELDS } from '@planogram/composables/plannerate/v3/useSectionFields';
import { DEFAULT_SHELF_FIELDS } from '@planogram/composables/plannerate/v3/useShelfFields';
...
const getInitialFormData = () => {
    ...
    return {
        ...
        // Step 4: Rack Configuration (do composable de seção)
