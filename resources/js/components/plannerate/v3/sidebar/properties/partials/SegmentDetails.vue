...
import { deleteImage } from '@/actions/App/Http/Controllers/Tenant/Plannerate/Api/ProductImageController';
...
import { useSegmentActions } from '@planogram/composables/plannerate/v3/useSegmentActions';
...
function handleDeleteProductImage() {
    ...
    router.delete(deleteImage.url(product.value.id), {
        onSuccess: () => {
