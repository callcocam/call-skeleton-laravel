...
import { uploadImage, deleteImage } from '@/actions/App/Http/Controllers/Tenant/Plannerate/Api/ProductImageController';
import type { Product } from '@planogram/types/planogram';
...
async function handleDeleteImage() {
    ...
    try {
        ...
        router.delete(deleteImage.url(props.product), {
            preserveScroll: true,
            preserveState: true,
            onSuccess: () => {
