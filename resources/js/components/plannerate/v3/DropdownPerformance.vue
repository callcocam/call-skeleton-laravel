...
import Performance from '@planogram/components/plannerate/v3/header/Performance.vue';
...
import { usePerformanceIndicators } from '@planogram/composables/plannerate/v3/usePerformanceIndicators';
import type { AbcAnalysis, Gondola, StockAnalysis } from '@planogram/types/planogram';
import { PlanogramOption } from '@planogram/types/workflow';
...
const planogram = computed(() => props.gondola.planogram as PlanogramOption);
</script>
