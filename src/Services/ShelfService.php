...
class ShelfService
{
    public function __construct(
        private PlanogramShelfRepositoryContract $repository,
        private PlanogramSectionRepositoryContract $sectionRepository,
        private PlanogramSegmentRepositoryContract $segmentRepository,
        private PlanogramLayerRepositoryContract $layerRepository
    ) {}
