...
namespace Callcocam\LaravelRaptorPlanogram\Services\Printing;
    ...
    protected function getImageAsBase64OrUrl(string $imageUrl): string
    {
        ...
        try {
            ...
            if (str_contains($imageUrl, '/storage/')) {
                $baseUrl = (string) config('plannogram.app_url', '');
            ...
            if (str_starts_with($imageUrl, '/')) {
                ...
                return rtrim((string) config('plannogram.app_url', ''), '/').$imageUrl;
            }
