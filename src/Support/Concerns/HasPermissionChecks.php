...
namespace VendorName\Skeleton\Support\Concerns;
 ...
 * 
 * @package VendorName\Skeleton\Support\Concerns
 */
trait HasPermissionChecks
{
    /**
    ...
    protected function resolvePolicy($resource): ?object
    {
        ...
        $defaultPolicyClass = 'VendorName\\Skeleton\\Policies\\DefaultPolicy';
